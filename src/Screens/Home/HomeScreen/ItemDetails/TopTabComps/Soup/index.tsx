...
import { AddToCart, RemoveFromCart, setFinalPrice } from '../../../../../../Redux/Reducers/Auth/actions';
...
const data = [
  ...
  },
  {
    ...
    body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, Lorem ipsum dolor sit ..',
    price: 'AED 28.50',
    imageSource: Assets.Item7,
  },
  // Add more data objects for additional items
];

const SoupScreen = (props:any) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(SoupScreen);