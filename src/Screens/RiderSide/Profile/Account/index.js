          ...
          <View style={style.card}>
            ...
            <View style={{marginRight: 30}}>
              <Text style={style.CardText}>
                {card && maskCardNumber(lastCard.cardNumber)}
              </Text>
        ...
        <View style={{flex: 1}}>
          <View style={style.Mainview}>
            ...
            <Text style={style.text1}>
              Unlock the ease of transactions by adding your account details.
              Experience hassle-free payments and enjoy the convenience of
