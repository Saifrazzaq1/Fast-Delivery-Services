                    ...
                    <View style={style.mapCard}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent:'space-between' }}>
                            <View>
                                ...
                                <Text style={style.maptext2}>Sweihan Road, zam zam hieght, 4th, 17</Text>
                            </View>
                            <Image source={Images.bike1} style={{height:37, width:37, alignSelf:'center'}} />
                        </View>
                    </View>

                    <TouchableOpacity style={style.pay} onPress={() => { }}>
                        <Icon type={IconType.Ionicons} name='card-outline'
                            size={24} color='black' style={{ marginRight: 5 }} />
