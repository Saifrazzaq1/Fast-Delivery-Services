    ...
    <View style={{backgroundColor: 'white', flex: 1}}>
      ...
      <View style={style.mainview}>
        ...
        <Text style={style.text}>
          Your account information has been sent. Please await verification{' '}
        </Text>
        <Text style={style.text1}>
          Confirmation of your account information has been sent. Kindly await
          the verification process, and once completed, you can seamlessly enjoy
